...
[`examples/profiles.py`](examples/profiles.py).
...
On Linux, `CAPIUM_FONTS_DIR` adds a custom font directory; `CAPIUM_SUPPRESS_FONT_WARNING=1` silences the
...
published and raise a clear error. Capium currently targets **Chromium 151**.
